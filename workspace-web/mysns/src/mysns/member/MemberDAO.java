...
public class MemberDAO {
	...
	public boolean login(String uid, String passwd) throws SQLException, ClassNotFoundException {
		conn = DBManager.getConnection();
	...
	public ArrayList<String> getNewMembers() throws SQLException, ClassNotFoundException {
