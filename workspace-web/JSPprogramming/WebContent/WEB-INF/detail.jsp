...
<html>
	...
	<body>
		<h4>게시물 보기</h4>	
			...
			<textarea cols="30" rows="5"><%=board.getContent() %></textarea>

		<div id="buttonGroup">
			<a href="list.jsp"><img src="../common/images/board/list.gif"/></a>
			<a href="modify_form.jsp?board_no=<%=%>"><img src="../common/images/board/modify.gif"/></a>
			<a href="delete.jsp"><img src="../common/images/board/delete.gif"/></a>
		</div>		
	</body>
</html>